...
%DIF DEL ../hirsch_plosone_initial_submit.tex   Fri Apr  5 09:31:36 2024
%DIF ADD hirsch_plosone_randr1.tex              Wed Apr 17 16:25:36 2024
...
%DIF < \textcurrency Current Address: Dept/Program/Center, Institution Name, City, State, Country % change symbol to "\textcurrency a" if more than one current address note
\DIFaddbegin \DIFadd{\textcurrency Current Address: Dept/Program/Center, Institution Name, City, State, Country %DIF >  change symbol to "\textcurrency a" if more than one current address note
}\DIFaddend % \textcurrency b Insert second current address 
% \textcurrency c Insert third current address

% Deceased author note
%DIF < \dag Deceased
\DIFaddbegin \DIFadd{\dag Deceased
}\DIFaddend 

% Group/Consortium Author Note
%DIF < \textpilcrow Membership list can be found in the Acknowledgments section.
\DIFaddbegin \DIFadd{\textpilcrow Membership list can be found in the Acknowledgments section.
}\DIFaddend 
...
%DIFDELCMD < {\Large
%DIFDELCMD < \textbf\newline{Inequality in measuring scholarly success: Variation in
%DIFDELCMD < the \emph{h}-index within and between disciplines}
%DIFDELCMD < }
%DIFDELCMD < \newline
...
between discipline inequalities. Using \DIFdelbegin \DIFdel{data from }\DIFdelend \DIFaddbegin \DIFadd{bibliometric data from 1960-2019
on }\DIFaddend over 50,000 high performing scientists \DIFaddbegin \DIFadd{- the top 2\% most frequently
cited authors - }\DIFaddend across 174 disciplines, we construct random effects
...
sole-authorship and female penalties\DIFdelbegin \DIFdel{, as well as
significant between discipline variation in terms of sole
authorship }\DIFdelend \DIFaddbegin \DIFadd{. Results also show that a sole
authorship penalty plays a signficant role in well-known
between-discipline variation}\DIFaddend . Field-specific models emphasize the
``apples-to-oranges\DIFdelbegin \DIFdel{'' }\DIFdelend \DIFaddbegin \DIFadd{,'' or incommensurable, }\DIFaddend property of cross-discipline
comparison \DIFaddbegin \DIFadd{with significant heterogeneity in sole-authorship and female
penalities within fields}\DIFaddend . Conclusions include continued caution when
...
broadly organize scholarly labor differ \DIFdelbegin \DIFdel{upon }\DIFdelend \DIFaddbegin \DIFadd{by }\DIFaddend several relevant factors.
\DIFdelbegin \DIFdel{Differences in demographic characteristics, like race and gender,
capture processes of racism and sexism }\DIFdelend \DIFaddbegin \DIFadd{Inequalities experienced by minoritized and women scholars point to
processes of social closure or exclusionary practices }\DIFaddend that limit the
...
\DIFdelbegin \DIFdel{Here, we ask three related questions:
}\DIFdelend 
...
%DIFDELCMD < %%%
\DIFdel{These questions arise from at least two important considerations. First,
...
inequality in academia \mbox{%DIFAUXCMD
\citep[see][ for
reviews]{fox_gender_2017, long_scientific_1995}}\hskip0pt%DIFAUXCMD
. }\DIFdelend From well-known pipeline effects to publication differences to varying
effects of parenthood, \DIFdelbegin \DIFdel{scholars have }\DIFdelend \DIFaddbegin \DIFadd{research has }\DIFaddend shown the multifaceted ways some
scholars are obstructed from paths to success at work
\DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citep[e.g.][ among
others]{fox_gender_2005, grant_revisiting_2000, morgan_unequal_2021}}\hskip0pt%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep{fox_gender_2005, fox_gender_2017, grant_revisiting_2000, long_scientific_1995, morgan_unequal_2021}}\hskip0pt%DIFAUXCMD
}\DIFaddend .
At the same time, differences exist in the distribution of resources to
disciplines\DIFdelbegin \DIFdel{as can be seen in variation in }\DIFdelend \DIFaddbegin \DIFadd{, such as the prioritization of the natural sciences and
engineering in }\DIFaddend federal funding and the \DIFdelbegin \DIFdel{way
resourcesare distributed }\DIFdelend \DIFaddbegin \DIFadd{unequal distribution of
resources, like salaries, }\DIFaddend to departments, the proxies for disciplines on
...
\citep{siler_who_2022}. \DIFdelbegin \DIFdel{Turning to }\DIFdelend \DIFaddbegin \DIFadd{Examining }\DIFaddend within and between discipline
...
simplifying summaries of academic labor through quantification. \DIFaddbegin \DIFadd{Here, we
...
\tightlist
\item
  \DIFadd{What is the variation within and between disciplines in the
  }\emph{\DIFadd{h}}\DIFadd{-index?
}\item
  \DIFadd{How do social factors, specifically gender and sole authorship,
  contribute to this variation?
}\item
  \DIFadd{How do within and between discipline factors vary across fields (e.g.,
  social sciences, medical sciences, natural sciences)?
}\end{enumerate}

\DIFaddend While prior work examines the \emph{h}-index by field, discipline, or
gender, less is known about how \DIFdelbegin \DIFdel{within and }\DIFdelend \DIFaddbegin \DIFadd{gender and sole authorship contribute to
}\emph{\DIFadd{both}} \DIFadd{within }\emph{\DIFadd{and}} \DIFaddend between discipline differences \DIFdelbegin \DIFdel{affect }\DIFdelend \DIFaddbegin \DIFadd{in
}\DIFaddend \emph{h}-index scores \DIFdelbegin \DIFdel{in relationship to one another
\mbox{%DIFAUXCMD
\citep{bihari_review_2023}}\hskip0pt%DIFAUXCMD
. To understand factors that contribute to
differences in scholar's }\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep{bihari_review_2023}}\hskip0pt%DIFAUXCMD
. This study extends
prior work on metrics in science generally and the }\DIFaddend \emph{h}-index
\DIFdelbegin \DIFdel{, or Hirsch index, we use data on over 50,000 high-performing scientists across 174 disciplines in the
United States. This analysis draws from Ioannidis et al.'s dataset
identifying the top scientists in the Scopus database
\mbox{%DIFAUXCMD
\citep{ioannidis_standardized_2019}}\hskip0pt%DIFAUXCMD
. To understand within and between
discipline differences, we use random effects within-between (REWB)
models predicting }\DIFdelend \DIFaddbegin \DIFadd{specifically by conceptualizing the inequality process as occurring via
intra-disciplinary and inter-disciplinary dynamics. Variation in }\DIFaddend the
\emph{h}-index \DIFdelbegin \DIFdel{with a range of factors including
...
distinct within and between disciplinary effects on }\emph{\DIFdel{h}}%DIFAUXCMD
\DIFdel{-index
scores, consistent with calls to develop multilevel analyses of gender
disparities in science \mbox{%DIFAUXCMD
\citep{fox_gender_2020}}\hskip0pt%DIFAUXCMD
...
third of the
variation in }\emph{\DIFdel{h}}%DIFAUXCMD
\DIFdel{-index is between rather than within
disciplines, suggesting an important }\DIFdelend \DIFaddbegin \DIFadd{may result from ``}\DIFaddend apples-to-oranges\DIFdelbegin \DIFdel{problem when
comparing the }\emph{\DIFdel{h}}%DIFAUXCMD
\DIFdel{-index across
disciplines . This apples-to-oranges
problem results in significant differences across fields as well, especially in terms of sole authorship. Conclusions highlight how the
continued use of the }\emph{\DIFdel{h}}%DIFAUXCMD
\DIFdel{-index or similar metrics for valuation
perpetuates inequality in science both within and
between disciplines}\DIFdelend \DIFaddbegin \DIFadd{'' comparisons across
...
differing publishing trajectories dependent on gender and coauthorship}\DIFaddend .

\DIFdelbegin %DIFDELCMD < \hypertarget{inequality-in-science}{%
%DIFDELCMD < \section{Inequality in science}\label{inequality-in-science}}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \subsection{\DIFadd{Inequality in Science}}\label{inequality-in-science}
\DIFaddend 
...
publications produced by a scientist \DIFaddbegin \DIFadd{often }\DIFaddend translates into tangible
...
- publication remains a \DIFdelbegin \DIFdel{site of persistent inequality \mbox{%DIFAUXCMD
\citep{xie_sex_1998}}\hskip0pt%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{potential site of stratification in terms of
both the number of publications scholars accrue over their careers and
the quality of those publications
\mbox{%DIFAUXCMD
\citep{xie_sex_1998, light_gender_2009}}\hskip0pt%DIFAUXCMD
}\DIFaddend . Early signs indicate that these
...
\DIFdelbegin %DIFDELCMD < \hypertarget{inequality-between-disciplines-and-fields}{%
%DIFDELCMD < \subsection{Inequality between disciplines and
%DIFDELCMD < fields}\label{inequality-between-disciplines-and-fields}}
%DIFDELCMD < %%%
...
\DIFdelbegin %DIFDELCMD < \hypertarget{the-risks-of-quantification}{%
%DIFDELCMD < \section{The risks of
%DIFDELCMD < quantification}\label{the-risks-of-quantification}}
%DIFDELCMD < %%%
...
\DIFdelbegin \DIFdel{used in the }\DIFdelend \DIFaddbegin \DIFadd{developed in the late nineteenth and }\DIFaddend early twentieth century that
...
\DIFdelbegin %DIFDELCMD < \hypertarget{the-case-of-the-h-index}{%
%DIFDELCMD < \subsection{The case of the h-index}\label{the-case-of-the-h-index}}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \subsubsection{\DIFadd{The Case of the h-index}}\label{the-case-of-the-h-index}
\DIFaddend 
...
\DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citep[see][ among others]{kelly_index_2006, purvis_index_2006}}\hskip0pt%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep[ among others]{kelly_index_2006, purvis_index_2006}}\hskip0pt%DIFAUXCMD
...
\citep{oregonstateuniversity_oregon_2020}\DIFaddbegin \DIFadd{)}\DIFaddend . Survey research in Germany
...
\DIFdelbegin %DIFDELCMD < \hypertarget{hypotheses}{%
%DIFDELCMD < \section{Hypotheses}\label{hypotheses}}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \subsection{\DIFadd{Hypotheses}}\label{hypotheses}
\DIFaddend 
...
\DIFdelbegin %DIFDELCMD < \hypertarget{within-discipline-hypotheses}{%
%DIFDELCMD < \subsection{Within discipline
%DIFDELCMD < hypotheses}\label{within-discipline-hypotheses}}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \subsubsection{\DIFadd{Within Discipline
...
\begin{quote}
\emph{Sole Author Hypothesis (H2):} Authors with \DIFdelbegin \DIFdel{more }\DIFdelend \DIFaddbegin \DIFadd{a higher share of
}\DIFaddend sole-authored publications will have lower \emph{h}-index scores, on
average.
\end{quote}

\DIFdelbegin %DIFDELCMD < \hypertarget{between-disciplines-hypotheses}{%
%DIFDELCMD < \subsection{Between disciplines
%DIFDELCMD < ypotheses}\label{between-disciplines-hypotheses}}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \subsubsection{\DIFadd{Between Disciplines
...
and material differences in resources, we examine \DIFdelbegin \DIFdel{three }\DIFdelend \DIFaddbegin \DIFadd{two }\DIFaddend related
hypotheses:

\begin{quote}
\emph{\DIFdelbegin \DIFdel{Disciplinary Differences }\DIFdelend \DIFaddbegin \DIFadd{Feminized Discipline }\DIFaddend Hypothesis (H3a):} \DIFdelbegin \DIFdel{A substantial amount
of the variation in the }\emph{\DIFdel{h}}%DIFAUXCMD
\DIFdel{-index likely occurs between
disciplines.
}%DIFDELCMD < \end{quote}
%DIFDELCMD < 
...
%DIFDELCMD < %%%
\emph{\DIFdel{Feminized Discipline Hypothesis (H3b):}} %DIFAUXCMD
\DIFdelend Disciplines with a higher
share of women will have lower \emph{h}-index scores, on average.
\end{quote}

\begin{quote}
\emph{Teamwork Variation Hypothesis (\DIFdelbegin \DIFdel{H3c}\DIFdelend \DIFaddbegin \DIFadd{H3b}\DIFaddend ):} Disciplines with a higher
share of sole authorship will have lower \emph{h}-index scores, on
average.
\end{quote}

\DIFdelbegin %DIFDELCMD < \hypertarget{field-level-hypothesis}{%
%DIFDELCMD < \subsection{Field-level Hypothesis}\label{field-level-hypothesis}}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \subsubsection{\DIFadd{Field-level Hypothesis}}\label{field-level-hypothesis}
\DIFaddend 
...
will exist in \DIFdelbegin \DIFdel{terms of within and between disciplinary differences in
}\DIFdelend \DIFaddbegin \DIFadd{the relationship of }\DIFaddend the \emph{h}-index \DIFaddbegin \DIFadd{to gender and
coauthorship at both the individual and disciplinary level}\DIFaddend .
\end{quote}

\DIFdelbegin %DIFDELCMD < \hypertarget{materials-and-methods}{%
%DIFDELCMD < \section{Materials and methods}\label{materials-and-methods}}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \section{\DIFadd{Materials and Methods}}\label{materials-and-methods}
\DIFaddend 
...
different fields.
\DIFdelbegin \DIFdel{Differences across fields in both the }\emph{\DIFdel{h}}%DIFAUXCMD
\DIFdel{-index
...
\DIFdelbegin %DIFDELCMD < \hypertarget{tbl-desc}{}
%DIFDELCMD < \setlength{\LTpost}{0mm}
%DIFDELCMD < %%%
...
\DIFdelbeginFL %DIFDELCMD < \tabularnewline
%DIFDELCMD < \begin{tabular}{lrrrrrr}
%DIFDELCMD < %%%
%DIF < \toprule
%DIFDELCMD < \hline
%DIFDELCMD <  &  & \multicolumn{5}{c}{Fields} \\ 
%DIFDELCMD < %%%
%DIF < \cmidrule(lr){3-7}
\DIFdelFL{Variable }%DIFDELCMD < & %%%
\DIFdelFL{All }%DIFDELCMD < & %%%
\DIFdelFL{Humanities }%DIFDELCMD < & %%%
\DIFdelFL{Medical }%DIFDELCMD < & %%%
\DIFdelFL{Prof. }%DIFDELCMD < & %%%
\DIFdelFL{Soc. Sci. }%DIFDELCMD < & %%%
\DIFdelFL{STEM }%DIFDELCMD < \\ 
%DIFDELCMD < \hline
%DIFDELCMD < %%%
%DIF < \midrule
\DIFdelFL{H-index }%DIFDELCMD < & %%%
\DIFdelFL{44.1 (20.9) }%DIFDELCMD < & %%%
\DIFdelFL{19.8 (10.4) }%DIFDELCMD < & %%%
\DIFdelFL{52.2 (21.7) }%DIFDELCMD < & %%%
\DIFdelFL{29.4 (10.7) }%DIFDELCMD < & %%%
\DIFdelFL{33.1 (15.0) }%DIFDELCMD < & %%%
\DIFdelFL{38.8 (17.6) }%DIFDELCMD < \\ 
%DIFDELCMD < %%%
\DIFdelFL{Percent female }%DIFDELCMD < & %%%
\DIFdelFL{19.1 (37.7) }%DIFDELCMD < & %%%
\DIFdelFL{30.8 (45.1) }%DIFDELCMD < & %%%
\DIFdelFL{22.1 (40.1) }%DIFDELCMD < & %%%
\DIFdelFL{20.7 (39.1) }%DIFDELCMD < & %%%
\DIFdelFL{28.3 (43.8) }%DIFDELCMD < & %%%
\DIFdelFL{13.7 (32.3) }%DIFDELCMD < \\ 
%DIFDELCMD < %%%
\DIFdelFL{Percent sole author }%DIFDELCMD < & %%%
\DIFdelFL{10.7 (14.4) }%DIFDELCMD < & %%%
\DIFdelFL{56.0 (31.4) }%DIFDELCMD < & %%%
\DIFdelFL{8.1~~(9.4) }%DIFDELCMD < & %%%
\DIFdelFL{18.2 (16.8) }%DIFDELCMD < & %%%
\DIFdelFL{24.6 (22.9) }%DIFDELCMD < & %%%
\DIFdelFL{9.1 (11.5) }%DIFDELCMD < \\ 
%DIFDELCMD < %%%
\DIFdelFL{Career length }%DIFDELCMD < & %%%
\DIFdelFL{35.3 (10.1) }%DIFDELCMD < & %%%
\DIFdelFL{33.6 (11.2) }%DIFDELCMD < & %%%
\DIFdelFL{36.2~~(9.3) }%DIFDELCMD < & %%%
\DIFdelFL{32.2~~(9.9) }%DIFDELCMD < & %%%
\DIFdelFL{34.7 (10.6) }%DIFDELCMD < & %%%
\DIFdelFL{34.7 (10.6) }%DIFDELCMD < \\ 
%DIFDELCMD < %%%
\DIFdelFL{Specialization }%DIFDELCMD < & %%%
\DIFdelFL{0.73 (0.19) }%DIFDELCMD < & %%%
\DIFdelFL{0.64 (0.21) }%DIFDELCMD < & %%%
\DIFdelFL{0.76 (0.18) }%DIFDELCMD < & %%%
\DIFdelFL{0.75 (0.21) }%DIFDELCMD < & %%%
\DIFdelFL{0.72 (0.19) }%DIFDELCMD < & %%%
\DIFdelFL{0.70 (0.20) }%DIFDELCMD < \\ 
%DIFDELCMD < %%%
\DIFdelFL{University count }%DIFDELCMD < & %%%
\DIFdelFL{198 (202) }%DIFDELCMD < & %%%
\DIFdelFL{255 (204) }%DIFDELCMD < & %%%
\DIFdelFL{185 (201) }%DIFDELCMD < & %%%
\DIFdelFL{166 (203) }%DIFDELCMD < & %%%
\DIFdelFL{246 (209) }%DIFDELCMD < & %%%
\DIFdelFL{204 (200) }%DIFDELCMD < \\ 
%DIFDELCMD < %%%
\DIFdelFL{N }%DIFDELCMD < & %%%
\DIFdelFL{54,825 }%DIFDELCMD < & %%%
\DIFdelFL{856 }%DIFDELCMD < & %%%
\DIFdelFL{25,581 }%DIFDELCMD < & %%%
\DIFdelFL{1,228 }%DIFDELCMD < & %%%
\DIFdelFL{3,987 }%DIFDELCMD < & %%%
\DIFdelFL{23,173 }%DIFDELCMD < \\ 
%DIFDELCMD < \hline
...
%DIFDELCMD < %%%
\DIFdelFL{Note: standard deviations shown in parenthesis}%DIFDELCMD < \\
...
\DIFdelbegin %DIFDELCMD < \hypertarget{analytic-strategy}{%
%DIFDELCMD < \section{Analytic Strategy}\label{analytic-strategy}}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \subsection{\DIFadd{Analytic Strategy}}\label{analytic-strategy}
\DIFaddend 

We model variation in \emph{h}\DIFdelbegin \DIFdel{-score indices }\DIFdelend \DIFaddbegin \DIFadd{-index scores }\DIFaddend across scholars using random
effects within-between (REWB) models \citep{bell_fixed_2019}. \DIFdelbegin \DIFdel{REWB }\DIFdelend \DIFaddbegin \DIFadd{Random
effects within-between (REWB) }\DIFaddend models are a variant of multilevel models
...
the mean of \DIFdelbegin \DIFdel{the }\DIFdelend \(x\) for cluster \(j\) (\(\bar{x}_{.j}\)) is included in
the model and \DIFdelbegin \DIFdel{the }\DIFdelend \(x_{ij}\) values are mean centered by cluster, the
\(\beta_1\) parameter is identical to that of a fixed-effects model in
which all between variance is absorbed by cluster-level \DIFdelbegin \DIFdel{dummies}\DIFdelend \DIFaddbegin \DIFadd{dummy variables}\DIFaddend .
...
\DIFdelbegin \DIFdel{combines }\DIFdelend \DIFaddbegin \DIFadd{maintains }\DIFaddend the advantage of \DIFaddbegin \DIFadd{traditional fixed effects models by }\DIFaddend absorbing
all cluster level differences when estimating \DIFdelbegin \DIFdel{individual level effects}\DIFdelend \DIFaddbegin \DIFadd{lower level parameters}\DIFaddend ,
while at the same time allowing for an analysis of the ``contextual''
\DIFdelbegin \DIFdel{effects of disciplines themselves}\DIFdelend \DIFaddbegin \DIFadd{relationships at the higher level}\DIFaddend .

We use this feature to estimate both within and between effects of
gender and sole authorship on a scholar's \emph{h}-index. \DIFdelbegin \DIFdel{We use 0-1
coding of }\DIFdelend \DIFaddbegin \DIFadd{Both }\DIFaddend the
probability of a female name \DIFaddbegin \DIFadd{variable and the sole authorship variable
are mean centered by discipline }\DIFaddend at the individual level \DIFdelbegin \DIFdel{to
mimic the
interpretation typical of a dummy variable on gender. We use
the }\DIFdelend \DIFaddbegin \DIFadd{so that the
interpretation of their effect is solely among scholars within the same
discipline. For the between discipline effects, we calculate the }\DIFaddend mean
probability of a female name \DIFdelbegin \DIFdel{in percentage terms (0-100) }\DIFdelend \DIFaddbegin \DIFadd{and the mean sole authorship of each
discipline. For probability of a female name, we use a 0 to 100
percentage scale }\DIFaddend at the disciplinary level \DIFdelbegin \DIFdel{to provide an estimate of the feminization of a given
discipline}\DIFdelend \DIFaddbegin \DIFadd{for ease of interpretation of
coefficients as the expected change in the }\emph{\DIFadd{h}}\DIFadd{-index for a one
percentage point increase in the mean probability of a female name}\DIFaddend . For
sole authorship, we use \DIFdelbegin \DIFdel{the percent of a scholar's
articles that are sole-authored at the individual level. At the
disciplinary level, we use a }\DIFdelend \DIFaddbegin \DIFadd{a }\DIFaddend natural log transformation of the mean percent
sole-authorship variable \DIFaddbegin \DIFadd{at the disciplinary level }\DIFaddend because exploratory
analysis indicated a negative diminishing returns relationship between
sole-authorship and the \emph{h}-index at this level.
\DIFdelbegin \DIFdel{Both of the individual level variables
are mean centered by discipline so that the interpretation of their
effect is solely among scholars within the same discipline. }\DIFdelend \DIFaddbegin 

\DIFaddend The control variables of career length, specialization, and university
...
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \section{\DIFadd{Results}}\label{results}
\DIFaddend 
...
that comparing the }\emph{\DIFdel{h}}%DIFAUXCMD
...
\DIFdelbegin %DIFDELCMD < \hypertarget{tbl-partition}{}
%DIFDELCMD < \begin{longtable}{lrrrrrr}
%DIFDELCMD < %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
%DIFDELCMD < \label{tbl-partition}%%%
\DIFdel{Parition of variance in }\emph{\DIFdel{h}}%DIFAUXCMD
\DIFdel{-indexscores between and within
disciplines }}%DIFAUXCMD
%DIFDELCMD < \tabularnewline
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \begin{table}
\begin{adjustwidth}{-1.5in}{0in} %DIF >  Comment out/remove adjustwidth environment if table fits in text column.
\DIFaddendFL 

\DIFdelbeginFL %DIFDELCMD < \toprule
%DIFDELCMD <  &  & \multicolumn{5}{c}{Field} \\ 
%DIFDELCMD < \cmidrule%%%
\DIFdelFL{(lr)}%DIFDELCMD < {%%%
\DIFdelFL{3-7}%DIFDELCMD < }
%DIFDELCMD < %%%
\DIFdelFL{Grouping }%DIFDELCMD < & %%%
\DIFdelFL{All }%DIFDELCMD < & %%%
\DIFdelFL{Humanities }%DIFDELCMD < & %%%
\DIFdelFL{Medical }%DIFDELCMD < & %%%
\DIFdelFL{Prof. }%DIFDELCMD < & %%%
...
%DIFDELCMD < \midrule
%DIFDELCMD < %%%
\DIFdelFL{Between discipline }%DIFDELCMD < & %%%
\DIFdelFL{$32.0\%$ }%DIFDELCMD < & %%%
\DIFdelFL{$53.6\%$ }%DIFDELCMD < & %%%
\DIFdelFL{$20.4\%$ }%DIFDELCMD < & %%%
\DIFdelFL{$16.2\%$ }%DIFDELCMD < & %%%
\DIFdelFL{$31.3\%$ }%DIFDELCMD < & %%%
\DIFdelFL{$20.1\%$ }%DIFDELCMD < \\ 
%DIFDELCMD < %%%
\DIFdelFL{Within discipline }%DIFDELCMD < & %%%
\DIFdelFL{$68.0\%$ }%DIFDELCMD < & %%%
\DIFdelFL{$46.4\%$ }%DIFDELCMD < & %%%
\DIFdelFL{$79.6\%$ }%DIFDELCMD < & %%%
\DIFdelFL{$83.8\%$ }%DIFDELCMD < & %%%
\DIFdelFL{$68.7\%$ }%DIFDELCMD < & %%%
\DIFdelFL{$79.9\%$ }%DIFDELCMD < \\ 
%DIFDELCMD < \bottomrule
%DIFDELCMD < \end{longtable}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \caption{\label{tbl-partition}\DIFaddFL{Partition of variance in }\emph{\DIFaddFL{h}}\DIFaddFL{-index
...
commonality may mispercieve the comparability of the }\emph{\DIFdel{h}}%DIFAUXCMD
\DIFdel{-index
...
\DIFdelbegin %DIFDELCMD < \hypertarget{tbl-models-full}{}
...
%DIFDELCMD < \hline
%DIFDELCMD <  & %%%
\DIFdelFL{Model 1 }%DIFDELCMD < & %%%
\DIFdelFL{Model 2 }%DIFDELCMD < & %%%
\DIFdelFL{Model 3 }%DIFDELCMD < & %%%
\DIFdelFL{Model 4 }%DIFDELCMD < \\
%DIFDELCMD < \hline
%DIFDELCMD < %%%
\DIFdelFL{Intercept                               }%DIFDELCMD < & %%%
\DIFdelFL{$39.32^{*}$ }%DIFDELCMD < & %%%
\DIFdelFL{$69.64^{*}$  }%DIFDELCMD < & %%%
\DIFdelFL{$68.89^{*}$  }%DIFDELCMD < & %%%
\DIFdelFL{$68.95^{*}$  }%DIFDELCMD < \\
%DIFDELCMD <                                         & %%%
\DIFdelFL{$(1.77)$    }%DIFDELCMD < & %%%
\DIFdelFL{$(2.12)$     }%DIFDELCMD < & %%%
\DIFdelFL{$(2.13)$     }%DIFDELCMD < & %%%
\DIFdelFL{$(2.06)$     }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdelFL{Prob. }%DIFDELCMD < [%%%
\DIFdelFL{0-1}%DIFDELCMD < ] %%%
\DIFdelFL{of female name$\dagger$     }%DIFDELCMD < & %%%
\DIFdelFL{$-2.95^{*}$ }%DIFDELCMD < &              & %%%
\DIFdelFL{$-3.64^{*}$  }%DIFDELCMD < & %%%
...
\DIFdelFL{$(0.23)$     }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdelFL{Disc. mean percent female name          }%DIFDELCMD < & %%%
...
\DIFdelFL{$(0.05)$     }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdelFL{Percent sole authored pubs$\dagger$     }%DIFDELCMD < &             & %%%
...
\DIFdelFL{$(0.01)$     }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdelFL{Disc. mean percent sole authored (log)  }%DIFDELCMD < &             & %%%
\DIFdelFL{$-12.87^{*}$ }%DIFDELCMD < & %%%
\DIFdelFL{$-13.36^{*}$ }%DIFDELCMD < & %%%
\DIFdelFL{$-13.50^{*}$ }%DIFDELCMD < \\
%DIFDELCMD <                                         &             & %%%
...
%DIFDELCMD < %%%
\DIFdelFL{Highly productive uni. count (stdized)* }%DIFDELCMD < &             &              &              & %%%
\DIFdelFL{$1.72^{*}$   }%DIFDELCMD < \\
%DIFDELCMD <                                         &             &              &              & %%%
\DIFdelFL{$(0.07)$     }%DIFDELCMD < \\
%DIFDELCMD < \hline
%DIFDELCMD < %%%
\DIFdelFL{Residual SD between discipline          }%DIFDELCMD < & %%%
\DIFdelFL{$11.86$     }%DIFDELCMD < & %%%
\DIFdelFL{$7.41$       }%DIFDELCMD < & %%%
\DIFdelFL{$7.34$       }%DIFDELCMD < & %%%
\DIFdelFL{$7.06$       }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdelFL{Residual SD within discipline           }%DIFDELCMD < & %%%
\DIFdelFL{$17.41$     }%DIFDELCMD < & %%%
\DIFdelFL{$16.83$      }%DIFDELCMD < & %%%
\DIFdelFL{$16.78$      }%DIFDELCMD < & %%%
\DIFdelFL{$16.34$      }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdelFL{N (discipline)                          }%DIFDELCMD < & %%%
\DIFdelFL{$174$       }%DIFDELCMD < & %%%
\DIFdelFL{$174$        }%DIFDELCMD < & %%%
\DIFdelFL{$174$        }%DIFDELCMD < & %%%
\DIFdelFL{$174$        }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdelFL{N (individual)                          }%DIFDELCMD < & %%%
\DIFdelFL{$54825$     }%DIFDELCMD < & %%%
\DIFdelFL{$54825$      }%DIFDELCMD < & %%%
\DIFdelFL{$54825$      }%DIFDELCMD < & %%%
\DIFdelFL{$54825$      }%DIFDELCMD < \\
%DIFDELCMD < \hline
%DIFDELCMD < \multicolumn{5}{l}{\scriptsize{$^{*}p<0.05$. Standard errors shown in parenthesis. $\dagger$=discipline mean centered; *=grand mean centered.}}
%DIFDELCMD < \end{tabular}
%DIFDELCMD < \label{table:coefficients}
...
The feminization of a discipline\DIFaddbegin \DIFadd{, }\DIFaddend as indicated by the mean percent
female name within the discipline\DIFaddbegin \DIFadd{, }\DIFaddend has a more complex relationship to
\emph{h}-index scores. Model 1 shows a slightly negative \DIFdelbegin \DIFdel{relationship
}\DIFdelend \DIFaddbegin \DIFadd{association
}\DIFaddend between percent female and mean \emph{h}-index scores across
disciplines. However, \DIFdelbegin \DIFdel{once the sole-authored variables were added to
the
model, this relationship reverses direction and }\DIFdelend \DIFaddbegin \DIFadd{this slightly negative association is a spurious
...
sole-authorship, the association between feminization and }\emph{\DIFadd{h}}\DIFadd{-index
scores }\DIFaddend becomes slightly positive. In the final model, we estimate that a
...
score for \DIFdelbegin \DIFdel{a discipline. The underlying issue is that highly feminized disciplines also tend to
be more focused on }\DIFdelend \DIFaddbegin \DIFadd{that discipline. Thus, when we compare disciplines with
similar }\DIFaddend sole-authorship \DIFdelbegin \DIFdel{(\(r=0.30\)). After accounting for
this disadvantage}\DIFdelend \DIFaddbegin \DIFadd{tendencies}\DIFaddend , feminized disciplines actually have
a slight advantage \DIFdelbegin \DIFdel{, although }\DIFdelend \DIFaddbegin \DIFadd{in mean }\emph{\DIFadd{h}}\DIFadd{-index scores, even though, }\DIFaddend within
...
disciplinary feminization within \DIFdelbegin \DIFdel{these fields, whereas }\DIFdelend \DIFaddbegin \DIFadd{all fields, except for the Social
Sciences. In contrast, }\DIFaddend we observed a moderate positive effect of
disciplinary feminization \DIFdelbegin \DIFdel{across all disciplines}\DIFdelend \DIFaddbegin \DIFadd{when we pool all fields}\DIFaddend . This finding implies
...
\DIFdelbegin \DIFdel{Overall, the heterogeneity of these effects across fields
indicates another problem of comparability when attempting to compare
scholars across disciplines and fields.
}\DIFdelend 

\DIFdelbegin %DIFDELCMD < \hypertarget{tbl-models-field}{}
%DIFDELCMD < \begin{table}[!t]
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \begin{table}
\DIFaddendFL \begin{adjustwidth}{-1.5in}{0in} % Comment out/remove adjustwidth environment if table fits in text column.
\caption{\label{tbl-models-field}Multilevel models predicting
\emph{h}\DIFdelbeginFL \DIFdelFL{-indexscore }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{-index score }\DIFaddendFL within each field. Clustering at the disciplinary
level.}
\DIFdelbeginFL %DIFDELCMD < \begin{center}
...
%DIFDELCMD < %%%
\DIFdelFL{Intercept                               }%DIFDELCMD < & %%%
\DIFdelFL{$79.11^{*}$  }%DIFDELCMD < & %%%
\DIFdelFL{$93.03^{*}$  }%DIFDELCMD < & %%%
\DIFdelFL{$47.21^{*}$ }%DIFDELCMD < & %%%
\DIFdelFL{$77.62^{*}$  }%DIFDELCMD < & %%%
\DIFdelFL{$60.05^{*}$  }%DIFDELCMD < \\
%DIFDELCMD <                                         & %%%
\DIFdelFL{$(12.61)$    }%DIFDELCMD < & %%%
\DIFdelFL{$(6.37)$     }%DIFDELCMD < & %%%
\DIFdelFL{$(8.33)$    }%DIFDELCMD < & %%%
\DIFdelFL{$(4.57)$     }%DIFDELCMD < & %%%
\DIFdelFL{$(5.04)$     }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdelFL{Prob. }%DIFDELCMD < [%%%
\DIFdelFL{0-1}%DIFDELCMD < ] %%%
\DIFdelFL{of female name$\dagger$     }%DIFDELCMD < & %%%
\DIFdelFL{$-1.35^{*}$  }%DIFDELCMD < & %%%
\DIFdelFL{$-3.67^{*}$  }%DIFDELCMD < & %%%
...
\DIFdelFL{$(0.72)$    }%DIFDELCMD < & %%%
\DIFdelFL{$(0.44)$     }%DIFDELCMD < & %%%
\DIFdelFL{$(0.38)$     }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdelFL{Disc. mean percent female name          }%DIFDELCMD < & %%%
...
%DIFDELCMD < %%%
\DIFdelFL{Disc. mean percent sole authored (log)  }%DIFDELCMD < & %%%
\DIFdelFL{$-15.40^{*}$ }%DIFDELCMD < & %%%
\DIFdelFL{$-21.73^{*}$ }%DIFDELCMD < & %%%
\DIFdelFL{$-6.94^{*}$ }%DIFDELCMD < & %%%
\DIFdelFL{$-13.62^{*}$ }%DIFDELCMD < & %%%
...
\DIFdelFL{0-1}%DIFDELCMD < ]%%%
\DIFdelFL{*                   }%DIFDELCMD < & %%%
\DIFdelFL{$-3.16^{*}$  }%DIFDELCMD < & %%%
\DIFdelFL{$0.03$       }%DIFDELCMD < & %%%
\DIFdelFL{$-0.49$     }%DIFDELCMD < & %%%
\DIFdelFL{$-6.32^{*}$  }%DIFDELCMD < & %%%
\DIFdelFL{$-4.37^{*}$  }%DIFDELCMD < \\
%DIFDELCMD <                                         & %%%
\DIFdelFL{$(1.10)$     }%DIFDELCMD < & %%%
\DIFdelFL{$(0.79)$     }%DIFDELCMD < & %%%
\DIFdelFL{$(1.55)$    }%DIFDELCMD < & %%%
...
%DIFDELCMD < %%%
\DIFdelFL{Residual SD between discipline          }%DIFDELCMD < & %%%
\DIFdelFL{$4.52$       }%DIFDELCMD < & %%%
\DIFdelFL{$6.71$       }%DIFDELCMD < & %%%
\DIFdelFL{$4.27$      }%DIFDELCMD < & %%%
\DIFdelFL{$3.14$       }%DIFDELCMD < & %%%
\DIFdelFL{$6.23$       }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdelFL{Residual SD within discipline           }%DIFDELCMD < & %%%
\DIFdelFL{$5.98$       }%DIFDELCMD < & %%%
\DIFdelFL{$18.69$      }%DIFDELCMD < & %%%
\DIFdelFL{$9.48$      }%DIFDELCMD < & %%%
\DIFdelFL{$11.31$      }%DIFDELCMD < & %%%
\DIFdelFL{$14.41$      }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdelFL{N (discipline)                          }%DIFDELCMD < & %%%
...
\DIFdelFL{N (individual)                          }%DIFDELCMD < & %%%
\DIFdelFL{$856$        }%DIFDELCMD < & %%%
\DIFdelFL{$25581$      }%DIFDELCMD < & %%%
\DIFdelFL{$1228$      }%DIFDELCMD < & %%%
\DIFdelFL{$3987$       }%DIFDELCMD < & %%%
\DIFdelFL{$23173$      }%DIFDELCMD < \\
%DIFDELCMD < \hline
%DIFDELCMD < \multicolumn{6}{l}{\scriptsize{$^{*}p<0.05$. Standard errors shown in parenthesis. $\dagger$=discipline mean centered; *=grand mean centered.}}
%DIFDELCMD < \end{tabular}
%DIFDELCMD < \label{table:coefficients}
%DIFDELCMD < \end{center}
%DIFDELCMD < %%%
...
The \DIFaddbegin \DIFadd{substantial heterogeneity across disciplines (roughly a third of all
variation) indicates that comparing the }\DIFaddend \emph{h}-index \DIFdelbegin \DIFdel{, or Hirsch Index, is a widely used metric used for
...
bibliometrics and inequality in science by examining both within and between discipline differences in the }\DIFdelend \DIFaddbegin \DIFadd{across
...
misperceive the comparability of the }\DIFaddend \emph{h}\DIFdelbegin \DIFdel{-index. We used REWB
models to predict the }\emph{\DIFdel{h}}%DIFAUXCMD
\DIFdelend -index \DIFdelbegin \DIFdel{for high-performing scholars in 174
disciplines
. }\DIFdelend \DIFaddbegin \DIFadd{across disciplines
more broadly.
}

\DIFaddend Results indicate that\DIFaddbegin \DIFadd{, within disciplines, }\DIFaddend gender and sole authorship
affect the \emph{h}-index\DIFdelbegin \DIFdel{providing support for our female penalty (}\DIFdelend \DIFaddbegin \DIFadd{. Consistent with }\DIFaddend H1 \DIFdelbegin \DIFdel{) and sole
authorship hypotheses (}\DIFdelend \DIFaddbegin \DIFadd{and }\DIFaddend H2\DIFdelbegin \DIFdel{). }\DIFdelend \DIFaddbegin \DIFadd{, we find that women
have lower }\emph{\DIFadd{h}}\DIFadd{-index scores than men and that more sole-authorship
is associated with lower }\emph{\DIFadd{h}}\DIFadd{-index scores, respectively. Thus,
...
substantial inequalities in }\emph{\DIFadd{h}}\DIFadd{-index scores.
}

\DIFaddend We find evidence of between discipline differences as well. \DIFdelbegin \DIFdel{Results provide support for the disciplinary
...
disciplines in terms of sole authorship, supporting the }\DIFdelend \DIFaddbegin \DIFadd{Disciplines
with more overall sole-authorship have substantially lower mean
}\emph{\DIFadd{h}}\DIFadd{-index scores overall, consistent with the }\DIFaddend teamwork variation
hypothesis (\DIFdelbegin \DIFdel{H3c}\DIFdelend \DIFaddbegin \DIFadd{H3b}\DIFaddend ). Support for the feminized discipline hypothesis (\DIFdelbegin \DIFdel{H3b)
is mixed. Results indicate that a small negative feminized discipline effect
reverses when including sole authorship and that }\DIFdelend \DIFaddbegin \DIFadd{H3a)
...
on }\emph{\DIFadd{h}}\DIFadd{-index scores only for the Social Sciences, and on effect for
...
\DIFadd{We also observe that both the within discipline and }\DIFaddend between discipline
effects \DIFdelbegin \DIFdel{likely result from compositional
differences across fieldsconfirming }\DIFdelend \DIFaddbegin \DIFadd{vary substantially across fields, consistent with }\DIFaddend the field
variation hypothesis (H4). \DIFdelbegin \DIFdel{In sum, important differences exist }\DIFdelend \DIFaddbegin \DIFadd{This heterogeneity in models across fields
...
overall predictors of productivity }\DIFaddend within and between disciplines \DIFdelbegin \DIFdel{in the }\emph{\DIFdel{h}}%DIFAUXCMD
\DIFdel{-index. Moreover, this analysis provides evidence that
across field evaluation with the }\emph{\DIFdel{h}}%DIFAUXCMD
\DIFdel{-index risks apples-to-oranges
comparison}\DIFdelend \DIFaddbegin \DIFadd{when
evaluating scholars, field heterogeneity in the effects of these
predictors will complicate the ability to make accurate comparisons}\DIFaddend .
...
focuses on gender \DIFdelbegin \DIFdel{as }\DIFdelend \DIFaddbegin \DIFadd{because }\DIFaddend it is possible \DIFdelbegin \DIFdel{, despite these weaknesses }\DIFdelend to infer gender from names\DIFdelbegin \DIFdel{and other }\DIFdelend \DIFaddbegin \DIFadd{,
despite some weaknesses in the approach. Other }\DIFaddend aspects of inequality,
...
\DIFdelbegin \DIFdel{In conclusion, this }\DIFdelend \DIFaddbegin \section{\DIFadd{Conclusion}}\label{conclusion}

\DIFadd{This }\DIFaddend analysis provides further evidence that metrics in performance
...
\citep{koopman_galton_2023} \DIFdelbegin \DIFdel{writes }\DIFdelend \DIFaddbegin \DIFadd{write }\DIFaddend about data usage generally, ``need to
be fervently attentive to the ways in which inequalities may be designed
into their data'' (pg. 16). In this vein, this analysis \DIFdelbegin \DIFdel{provided }\DIFdelend \DIFaddbegin \DIFadd{provides
}\DIFaddend evidence of within and between discipline differences in the
\emph{h}-index with a focus on gender \DIFdelbegin \DIFdel{, but there is
reason to believe that the bias embedded }\DIFdelend \DIFaddbegin \DIFadd{and sole authorship, but variation
}\DIFaddend in scholarly metrics \DIFdelbegin \DIFdel{extends }\DIFdelend \DIFaddbegin \DIFadd{may extend }\DIFaddend to other dimensions of power, including
race, class, and sexual orientation\DIFaddbegin \DIFadd{, or be related to other academic
practices, like research funding, teaching loads, or service
responsibilities}\DIFaddend .
...
\DIFdelbegin \DIFdel{the authors have no acknowledgements to provide}\DIFdelend \DIFaddbegin \DIFadd{We thank Nicholas Theis and jimi adams for their helpful comments on
previous drafts of this article}\DIFaddend .
...
\newblock The Diversity\DIFdelbegin \DIFdel{\textendash }\DIFdelend \DIFaddbegin {\DIFadd{\textendash}}\DIFaddend Innovation Paradox in Science.
...
\DIFaddbegin \bibitem{fox_gender_2005}
\DIFadd{Fox MF.
}\newblock \DIFadd{Gender, Family Characteristics, and Publication Productivity among Scientists.
}\newblock \DIFadd{Social Studies of Science. 2005;35(1):131--150.
}

\DIFaddend \bibitem{fox_gender_2017}
...
\DIFdelbegin \bibitem{long_scientific_1995}
\DIFdel{Long JS, Fox MF.
}%DIFDELCMD < \newblock %%%
\DIFdel{Scientific Careers: }%DIFDELCMD < {{%%%
\DIFdel{Universalism}%DIFDELCMD < }} %%%
\DIFdel{and Particularism.
}%DIFDELCMD < \newblock %%%
\DIFdel{Annual review of sociology. 1995;21(1):45--71.
}%DIFDELCMD < 

%DIFDELCMD < \bibitem{fox_gender_2005}
\DIFdel{Fox MF.
}%DIFDELCMD < \newblock %%%
\DIFdel{Gender, Family Characteristics, and Publication Productivity among Scientists.
}%DIFDELCMD < \newblock %%%
\DIFdel{Social Studies of Science. 2005;35(1):131--150.
}%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdelend \bibitem{grant_revisiting_2000}
...
\DIFaddbegin \bibitem{long_scientific_1995}
\DIFadd{Long JS, Fox MF.
}\newblock \DIFadd{Scientific Careers: }{{\DIFadd{Universalism}}} \DIFadd{and Particularism.
}\newblock \DIFadd{Annual review of sociology. 1995;21(1):45--71.
}

\DIFaddend \bibitem{morgan_unequal_2021}
...
\DIFdelbegin \bibitem{fox_gender_2020}
\DIFdel{Fox MF.
}%DIFDELCMD < \newblock %%%
\DIFdel{Gender, Science, and Academic Rank: }%DIFDELCMD < {{%%%
\DIFdel{Key}%DIFDELCMD < }} %%%
\DIFdel{Issues and Approaches.
}%DIFDELCMD < \newblock %%%
\DIFdel{Quantitative Science Studies. 2020;1(3):1001--1006.
}%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdelend \bibitem{cech_professional_2011}
...
\DIFaddbegin \bibitem{light_gender_2009}
\DIFadd{Light R.
}\newblock \DIFadd{Gender Stratification and Publication in }{{\DIFadd{American}}} \DIFadd{Science: }{{\DIFadd{Turning}}} \DIFadd{the Tools of Science Inward.
}\newblock \DIFadd{Sociology Compass. 2009;3(4):721--733.
}

\DIFaddend \bibitem{king_pandemic_2021}
...
\DIFdelbegin \bibitem{light_gender_2009}
\DIFdel{Light R.
}%DIFDELCMD < \newblock %%%
\DIFdel{Gender Stratification and Publication in }%DIFDELCMD < {{%%%
\DIFdel{American}%DIFDELCMD < }} %%%
\DIFdel{Science: }%DIFDELCMD < {{%%%
\DIFdel{Turning}%DIFDELCMD < }} %%%
...
%DIFDELCMD < %%%
\DIFdelend \bibitem{lynn_rare_2019}
...
\DIFdelbegin %DIFDELCMD < \hypertarget{supporting-information}{%
%DIFDELCMD < \section{Supporting information}\label{supporting-information}}
%DIFDELCMD < %%%
