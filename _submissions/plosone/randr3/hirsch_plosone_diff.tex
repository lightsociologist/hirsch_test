...
%DIF ADD hirsch_plosone_randr3.tex             Thu Oct 17 12:04:49 2024
...
\caption{\label{tbl-partition}\DIFaddFL{Partition of variance in }\emph{\DIFaddFL{h}}\DIFaddFL{-index
...
\DIFdelFL{Partition of variance in }\emph{\DIFdelFL{h}}%DIFAUXCMD
\DIFdelFL{-index
scores between and within disciplines}}
%DIFAUXCMD
%DIFDELCMD < 
...
\newblock doi:{10.1371/journal.pone.0228914\DIFaddbegin }\DIFadd{.
}
...
}\newblock \DIFadd{doi:}{\DIFadd{10.1089/ees.2016.0223}\DIFaddend }.
