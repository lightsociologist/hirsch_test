...
%DIF DEL ../randr1/hirsch_plosone_randr1.tex   Thu Aug 15 13:29:52 2024
%DIF ADD hirsch_plosone_randr2.tex             Thu Aug 15 13:46:11 2024
...
used in the evaluation of scholarly research\DIFdelbegin \DIFdel{, despite warnings about
}\DIFdelend \DIFaddbegin \DIFadd{; however, the risk of
}\DIFaddend apples-to-oranges comparisons given within discipline and between
discipline differences \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citep{hicks_bibliometrics_2015, ioannidis_standardized_2019}}\hskip0pt%DIFAUXCMD
. }\DIFdelend \DIFaddbegin \DIFadd{requires greater scrutiny
\mbox{%DIFAUXCMD
\citep{hicks_bibliometrics_2015, ioannidis_standardized_2019} }\hskip0pt%DIFAUXCMD
alongside
continued efforts towards metrics literacy, or the ability ``critically
assess and effectively and ethically use scholarly
metrics''\mbox{%DIFAUXCMD
\citep{maggio_becoming_2022}}\hskip0pt%DIFAUXCMD
. Prior research identifies
...
\mbox{%DIFAUXCMD
\citep{maggio_becoming_2022}}\hskip0pt%DIFAUXCMD
. }\DIFaddend The most widely used metric of this type
is the \emph{h}-index, a simple score where a scholar with 10 published
articles with at least 10 citations receives \DIFdelbegin \DIFdel{a }\DIFdelend \DIFaddbegin \DIFadd{an }\DIFaddend \emph{h}-index of 10.
...
between disciplines. \DIFaddbegin \DIFadd{A greater understanding of these processes can help
...
\DIFdelbegin \DIFdel{At the same time, differences }\DIFdelend \DIFaddbegin \DIFadd{Differences }\DIFaddend exist in the distribution of resources to disciplines, such
...
\citep{katz_metrics_2020}. \DIFdelbegin \DIFdel{Second}\DIFdelend \DIFaddbegin \DIFadd{At the same time}\DIFaddend , numerous scholars have
drawn \DIFaddbegin \DIFadd{critical }\DIFaddend attention to the increasing push to quantify aspects of
social life \citep{mennicken_what_2019}. \DIFdelbegin \DIFdel{Research on the risks of
...
good or bad. }\DIFdelend In the case of scholarly
...
to inequalities and contributes to research on \DIFaddbegin \DIFadd{improving research
metrics for evaluation purposes as well as research on }\DIFaddend the limitations
...
apple-to-oranges comparisons when using common scholarly metrics \DIFdelbegin \DIFdel{, }\DIFdelend like
the \emph{h}-index?
...
summarize entire careers for administrators who \DIFdelbegin \DIFdel{likely have little
to no
}\DIFdelend \DIFaddbegin \DIFadd{may have little
}\DIFaddend understanding of the research that the metrics summarize.
...
evaluation processes, metrics\DIFaddbegin \DIFadd{, }\DIFaddend such as citation counts, journal impact
factors, and the \emph{h}-index\DIFaddbegin \DIFadd{, }\DIFaddend are now commonly incorporated into
hiring and promotion decisions \citep{mckiernan_metaresearch_2019} and
are seen as more important to \DIFdelbegin \DIFdel{more vulnerable }\DIFdelend untenured scholars than tenured ones
\citep{niles_why_2020}. \DIFdelbegin \DIFdel{Qualitative expert assessment that
involves hours of engagement with the work summarized by metricsmay be
devalued by administrators motivated by a logic that privileges
competition, central decision-making, and
market valuation
\mbox{%DIFAUXCMD
\citep{berg_producing_2016}}\hskip0pt%DIFAUXCMD
. }\DIFdelend \DIFaddbegin \DIFadd{While many administrators likely have a broad
...
\citep{forrester_mental_2021}. \DIFdelbegin \DIFdel{Administrators}\DIFdelend \DIFaddbegin \DIFadd{From this perspective, administrators}\DIFaddend '
continued reliance upon metrics serves as a modern form of \DIFaddbegin \DIFadd{academic
}\DIFaddend Taylorism, a production principle developed in the late nineteenth and
...
labor process itself. \DIFdelbegin \DIFdel{Prioritizing }\DIFdelend \DIFaddbegin \DIFadd{To critics, prioritizing }\DIFaddend metrics creates a demand
...
\emph{h}-index \DIFdelbegin \DIFdel{indicate }\DIFdelend \DIFaddbegin \DIFadd{indicates }\DIFaddend that natural scientists widely understand the
...
This variation \DIFdelbegin \DIFdel{is unfortunate as quantitative metrics are widely applied
in German universities as elsewhere}\DIFdelend \DIFaddbegin \DIFadd{in knowledge motivates calls for expanding metrics
literacy efforts
\mbox{%DIFAUXCMD
\citep{ioannidis_citation_2020, maggio_becoming_2022, rousseau_becoming_2018}}\hskip0pt%DIFAUXCMD
}\DIFaddend .
...
evaluation in academia should be used with caution \DIFdelbegin \DIFdel{, if at all}\DIFdelend \DIFaddbegin \DIFadd{and efforts towards
metrics literacy should include both within and between discipline
variation}\DIFaddend . Metrics are subject to within and between discipline biases
that \DIFdelbegin \DIFdel{severely }\DIFdelend hinder their value in making both intradisciplinary and
...
\newblock The \DIFdelbegin \DIFdel{Diversity}%DIFDELCMD < {%%%
\DIFdel{\textendash}%DIFDELCMD < }%%%
\DIFdel{Innovation }\DIFdelend \DIFaddbegin \DIFadd{Diversity--Innovation }\DIFaddend Paradox in Science.
...
\DIFdelend Harvard University Press\DIFdelbegin %DIFDELCMD < }%%%
\DIFdelend ; 2012.
...
\DIFaddbegin \bibitem{maggio_becoming_2022}
\DIFadd{Maggio LA, Jeffrey A, Haustein S, Samuel A.
}\newblock \DIFadd{Becoming Metrics Literate: }{{\DIFadd{An}}} \DIFadd{Analysis of Brief Videos That Teach about the h-Index.
}\newblock \DIFadd{PLOS ONE. 2022;17(5):e0268110.
}\newblock \DIFadd{doi:}{\DIFadd{10.1371/journal.pone.0268110}}\DIFadd{.
}

\bibitem{hammarfelt_conflicting_2018}
\DIFadd{Hammarfelt B, Haddow G.
}\newblock \DIFadd{Conflicting Measures and Values: }{{\DIFadd{How}}} \DIFadd{Humanities Scholars in }{{\DIFadd{Australia}}} \DIFadd{and }{{\DIFadd{Sweden}}} \DIFadd{Use and React to Bibliometric Indicators.
}\newblock \DIFadd{Journal of the Association for Information Science and Technology. 2018;69(7):924--935.
}\newblock \DIFadd{doi:}{\DIFadd{10.1002/asi.24043}}\DIFadd{.
}

\bibitem{kamrani_researchers_2021}
\DIFadd{Kamrani P, Dorsch I, Stock WG.
}\newblock \DIFadd{Do Researchers Know What the H-Index Is? }{{\DIFadd{And}}} \DIFadd{How Do They Estimate Its Importance?
}\newblock \DIFadd{Scientometrics. 2021;126(7):5489--5508.
}\newblock \DIFadd{doi:}{\DIFadd{10.1007/s11192-021-03968-1}}\DIFadd{.
}

\bibitem{rousseau_becoming_2018}
\DIFadd{Rousseau R, Egghe L, Guns R.
}\newblock \DIFadd{Becoming }{{\DIFadd{Metric-Wise}}}\DIFadd{: }{{\DIFadd{A Bibliometric Guide}}} \DIFadd{for }{{\DIFadd{Researchers}}}\DIFadd{.
}\newblock \DIFadd{Chandos Publishing; 2018.
}
...
\newblock \DIFdelbegin %DIFDELCMD < {%%%
\DIFdelend Princeton University Press\DIFdelbegin %DIFDELCMD < }%%%
\DIFdelend ; 2019.
...
\newblock In: Networks, Work and Inequality. vol.~24. \DIFdelbegin %DIFDELCMD < {%%%
\DIFdelend Emerald Group Publishing Limited\DIFdelbegin %DIFDELCMD < }%%%
\DIFdelend ; 2013. p. 239--268.
...
\newblock \DIFdelbegin %DIFDELCMD < {%%%
\DIFdelend Cambridge University Press\DIFdelbegin %DIFDELCMD < }%%%
\DIFdelend ; 2012.
...
\newblock \DIFdelbegin %DIFDELCMD < {%%%
\DIFdel{nyu Press}%DIFDELCMD < }%%%
\DIFdelend \DIFaddbegin \DIFadd{nyu Press}\DIFaddend ; 1998.
...
\DIFdelbegin \bibitem{kamrani_researchers_2021}
\DIFdel{Kamrani P, Dorsch I, Stock WG}\DIFdelend \DIFaddbegin \bibitem{ioannidis_citation_2020}
\DIFadd{Ioannidis JPA, Boyack KW.
}\newblock \DIFadd{Citation Metrics for Appraising Scientists: Misuse, Gaming and Proper Use}\DIFaddend .
\newblock \DIFdelbegin \DIFdel{Do Researchers Know What the H-Index Is? }%DIFDELCMD < {{%%%
\DIFdel{And}%DIFDELCMD < }} %%%
\DIFdel{How Do They Estimate Its Importance?
}%DIFDELCMD < \newblock %%%
\DIFdel{Scientometrics. 2021;126(7):5489--5508}\DIFdelend \DIFaddbegin \DIFadd{Medical Journal of Australia. 2020;212(6)}\DIFaddend .
\newblock doi:{\DIFdelbegin \DIFdel{10.1007}\DIFdelend \DIFaddbegin \DIFadd{10.5694}\DIFaddend /\DIFdelbegin \DIFdel{s11192-021-03968-1}\DIFdelend \DIFaddbegin \DIFadd{mja2.50493}\DIFaddend }.
...
\newblock \DIFdelbegin %DIFDELCMD < {%%%
\DIFdelend St. Martin's Press\DIFdelbegin %DIFDELCMD < }%%%
\DIFdelend ; 2018.
