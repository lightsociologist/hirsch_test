...
While prior work examines the *h*-index by field, discipline, or gender, less is known about the factors, like gender and coauthorship, contributing to *both* within *and* between discipline differences in *h*-index scores [@bihari_review_2023]. This study extends prior work on metrics in science generally and the *h*-index specifically by conceptualizing the inequality process as occuring via intra-disciplinary and inter-disciplinary dynamics. Variation in the *h*-index may result from "apples-to-oranges" comparisons across disiplines and fields due to specific factors, like gender and coauthorship, but also occur within disciplines, as scholars experience differing publishing trajectories dependent on gender and coauthorship.
